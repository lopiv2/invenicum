  ...
  Future<List<InventoryItem>> fetchInventoryItems({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Asumimos que la lista de ítems está anidada en 'data'.
  ...
  Future<InventoryItem> updateInventoryItem(InventoryItem item) async {
    try {
      ...
      if (response.statusCode == 200) { // 200 OK
        ...
        throw Exception('Error al actualizar activo: Código ${response.statusCode}');
      }
    } on DioException catch (e) {
      rethrow;
    } catch (e) {
  ...
  Future<void> deleteInventoryItem(int itemId) async {
    try {
      ...
      if (response.statusCode != 204 && response.statusCode != 200) {
        ...
        throw Exception('Error al eliminar activo: Código ${response.statusCode}');
      }
