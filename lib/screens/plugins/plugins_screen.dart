        ...
        body: Consumer<PluginProvider>(
          builder: (context, provider, _) {
            ...
            return TabBarView(
              ...
              children: [
                _PluginGrid(plugins: provider.installedFromStore, type: 'library'),
                _PluginGrid(plugins: provider.myCreatedPlugins, type: 'mine'),
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 4, // 🚩 Lo he vuelto a poner en 2 para que se vean bien las tarjetas
        crossAxisSpacing: 14,
        mainAxisSpacing: 14,
        childAspectRatio: 0.55,
        mainAxisExtent: 240, // 🚩 Aumentado un poco para evitar overflow de texto
      ),
